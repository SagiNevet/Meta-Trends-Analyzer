...
### שותפי הפרויקט וזכויות יוצרים

**שותפי הפרויקט:** שגיא נבט · פרופסור אריק שדה  

התוכנה, העיצוב, מסמכי הפרויקט והקוד (למעט ספריות צד־שלישי בכפוף לרישיונותיהן) הם קניין של שותפי הפרויקט לעיל. **כל הזכויות שמורות.** אין להעתיק, להפיץ או לעשות שימוש מסחרי ללא הסכמה מפורשת בכתב.
...
הפרויקט מוגן בזכויות יוצרים. ראו קובץ `LICENSE` בשורש המאגר ואת סעיף **שותפי הפרויקט וזכויות יוצרים** לעיל.
